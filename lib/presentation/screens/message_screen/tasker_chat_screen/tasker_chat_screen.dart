...
class TaskerChatScreen extends StatefulWidget {
  final String? text;

  const TaskerChatScreen({super.key, required this.text});

  @override
  State<TaskerChatScreen> createState() => _TaskerChatScreenState();
}

class _TaskerChatScreenState extends State<TaskerChatScreen> {
