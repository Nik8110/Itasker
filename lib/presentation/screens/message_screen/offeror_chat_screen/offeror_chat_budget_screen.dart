...
class OfferorChatBudgetScreen extends StatefulWidget {
  const OfferorChatBudgetScreen({super.key});

  @override
  State<OfferorChatBudgetScreen> createState() =>
      _OfferorChatBudgetScreenState();
}

class _OfferorChatBudgetScreenState extends State<OfferorChatBudgetScreen> {
                ...
                children: [
                  ListTile(
                    leading: Container(
                      ...
                      child: Assets.images.technology.image(scale: 3),
                    ),
                    ...
                    title: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 5.h),
                        Text(
                          'Desarrollo web o reparación de laptop',
                  ...
                  Padding(
                    ...
                    child: Text(
                      'Necesito que reparen la ventilación de mi laptop modelo ASUS g14 y que cambien la pasta térmica la procesador. Yo no cuento con ninguna herramienta.',
                      style: Const.medium
                          .copyWith(fontSize: 15.sp, color: Const.kBlackShade5),
                    ),
                  ),
                  SizedBox(height: 20.h),
                  SizedBox(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            SizedBox(width: 5.w),
                            const Icon(Icons.star, color: Const.kYellowShade1),
                            SizedBox(width: 5.w),
                            Flexible(
                              child: Text(
                                '(4) | Miembro desde 2023',
                                style: Const.medium.copyWith(
                                    fontSize: 15.sp, color: Const.kBlackShade6),
                              ),
                            )
                          ],
                        ),
